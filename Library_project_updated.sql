...
--How to make F0reign Key by adding alter command
...
INSERT INTO employee(emp_id, emp_name, positions, salary, branch_id) 
VALUES
...
Update members 
set member_address = 'Choolai 9/4'
...
Select Count(issued_member_id) as  C, issued_member_id 
--Rank() (Partition by C order by desc )
from issued_status
...
Select x.issued_book_name, x.issued_id,
x.issued_member_id
From issued_status as x
Left join Return_status as x1
on x.issued_id = x1.issued_id
where  return_id is NUll

Select Distinct x.issued_book_name
From issued_status as x
Left join Return_status as x1
on x.issued_id = x1.issued_id
where  return_id is NUll
